  ...
  return (
    <Box sx={{ display: "flex", flexDirection: "column", mt: 10 }}>
      <Box sx={{ display: "flex", flexDirection: "row", gap: 2 }}>
        <Paper
          elevation={2}
          sx={{ width: "45%", flexGrow: 1, px: 5, pt: 4, pb: 10 }}
        >
          ...
          <Typography variant="body2">
            ...
            <br />
            It's pronounced Fufu and it uses the hangul commonly used to denote
            'lol' in Korean.
            <br />
            I thought it looked like a backwards 'F' so I decided to think of
            fun words that start with 'F', in the hopes of discovering a name
            for the app!
            <br />
            <Typography fontStyle={"italic"} component="b" sx={{ my: 1 }}>
              Something short and sweet, like a laugh or chuckle...
            </Typography>
            That's when I vaguely remembered the existence of a Japanese
            onomatopoeia for chuckle,{" "}
            <Typography
              display={"inline"}
              component="b"
              fontWeight="bold"
            ...
            >
              Please go ahead and use the box to the right to get started with
              your practice!
            </Typography>
          </Typography>
        </Paper>
