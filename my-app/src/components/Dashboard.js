...
export default function Dashboard({ user, setPracticeSession, setHangul, hangul }) {
  ...
  const navigate = useNavigate();
	...
	useEffect(() => {
		fetch('http://localhost:3000/hangul')
			.then((response) => {
